...
namespace ValeActivitiesCentre.Controllers
{
    public class StaffsController : Controller
    {
        ...
        {
            ViewBag.StaffID = new SelectList(db.People, "PersonID", "FirstName");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "StaffID,Department,JobPosition,Profile")] Staff staff)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "StaffID,Department,JobPosition,Profile")] Staff staff)
        {
            if (ModelState.IsValid)
            {
